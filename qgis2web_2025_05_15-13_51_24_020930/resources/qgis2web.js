...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-8557606.090866, 4466083.148526, -8553607.119387, 4469018.749210], maxZoom: 28, minZoom: 16
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-8557606.090866, 4466083.148526, -8553607.119387, 4469018.749210], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Project_Stroech</h2>';
        return titleElement;
    })(),
